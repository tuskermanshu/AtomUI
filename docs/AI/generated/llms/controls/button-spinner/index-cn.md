...
来源：`controlgallery/AtomUIGallery/ShowCases/Navigation/ButtonSpinner/Views/ButtonSpinnerShowCase.axaml:78`
...
来源：`controlgallery/AtomUIGallery/ShowCases/Navigation/ButtonSpinner/Views/ButtonSpinnerShowCase.axaml:94`
...
来源：`controlgallery/AtomUIGallery/ShowCases/Navigation/ButtonSpinner/Views/ButtonSpinnerShowCase.axaml:157`

Gallery key：`ExamplesContent` / item `2`

```axaml
<StackPanel Orientation="Vertical" Spacing="10">
    <atom:ButtonSpinner StyleVariant="Outlined">
        <atom:TextBlock
            HorizontalAlignment="Left"
            VerticalAlignment="Center"
            Text="床前明月光" />
...
来源：`controlgallery/AtomUIGallery/ShowCases/Navigation/ButtonSpinner/Views/ButtonSpinnerShowCase.axaml:187`

Gallery key：`ExamplesContent` / item `3`

```axaml
<StackPanel Orientation="Vertical" Spacing="10">
    <atom:ButtonSpinner StyleVariant="Outlined" IsEnabled="False">
        <atom:TextBlock
            HorizontalAlignment="Left"
            VerticalAlignment="Center"
            Text="床前明月光" />
...
- 源设计文档：`docs/controls/desktop/navigation/button-spinner/overview.md`
- 实现文档：`docs/controls/desktop/navigation/button-spinner/implementation.md`
- Semantic Part 文档：`docs/controls/desktop/navigation/button-spinner/semantic-part.md`
- Token 文档：`docs/controls/desktop/navigation/button-spinner/token.md`
- 变更记录：`docs/controls/desktop/navigation/button-spinner/changelog.md`
- 语义结构：`./semantic-cn.md`
